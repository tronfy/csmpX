ServerEvents.recipes(event => {
  ...
  event.shaped(Item.of('cataclysm:monstrous_eye', 1), ['ABA', 'CDC', 'ABA'], {
  ...
  event.shaped(Item.of('cataclysm:flame_eye', 1), ['AAA', 'BCD', 'EEE'], {
  ...
  event.recipes
    .createMixing('endrem:witch_pupil', [
  ...
  event.recipes
    .createMixing('endrem:witch_eye', ['minecraft:ender_eye', 'endrem:witch_pupil', 'minecraft:crying_obsidian'])
    .superheated()
  ...
  event.shaped(Item.of('botania:flight_tiara', 1), ['AAA', 'BAB', 'CDC'], {
  ...
  event.shaped(Item.of('numismatics:bank_terminal', 1), [' A ', ' B ', ' C '], {
  ...
  event.shapeless(Item.of('createaddition:zinc_sheet', 1), [
    //converter zinc sheet de um mod no outro
    'createdeco:zinc_sheet',
  ])
  event.shapeless(Item.of('createdeco:zinc_sheet', 1), [
    //converter zinc sheet de um mod no outro
    'createaddition:zinc_sheet',
  ])

  event.recipes.createFilling('minecraft:oxidized_copper', [
    //receita para oxidar copper
